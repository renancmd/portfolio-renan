...
const projectsData = [
	{
		...
		description: "Mod e Ferramenta Open-Source para gerenciamento de chunks no Hytale",
	...
	},
	{
		...
		description: "(Em progresso...) - Password manager Open-Source de uso local, garantindo controle total",
	...
	},
	{
		...
		technologies: ["HTML", "CSS", "JavaScript", "Java", "Spark", "PostgreSQL", "Azure", "Azure Vision AI"],
		category: ["Destaques", "Web"],
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-12">
							<div className="bg-gray-900 p-8 rounded-lg shadow-lg">
								...
								<ul className="list-disc list-inside text-gray-300 space-y-2">
									<li>Cybersecurity & Pentest</li>
									<li>Security Tools & OWASP</li>
									<li>Redes & Protocolos</li>
									<li>Linux Avançado & VMs</li>
									<li>Python & Bash</li>
									<li>Java & C/C++</li>
									<li>React & TypeScript</li>
									<li>Bases de Dados (PgSQL, MySQL, Firebase)</li>
								</ul>
							</div>
							<div className="bg-gray-900 p-8 rounded-lg shadow-lg">
