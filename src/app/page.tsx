...
const projectsData = [
  {
    title:
      "CyberResearch - Artigo Científico",
    image: "/images/projects/pesquisa-aplicada.png",
    description:
      "Pesquisa científica aplicada sobre o uso da IA em cibersegurança",
    technologies: ["Artigo", "Overleaf"],
    category: ["Destaques", "GUI/CLI"],
    repoLink: "https://github.com/renancmd/cyber-research",
    liveLink: "/pdf/Artigo_TI3.pdf",
  },
  {
    title: "ReChunk",
    image: "/images/projects/ReChunk.png",
    description:
      "Mod e Ferramenta Open-Source para gerenciamento de chunks no Hytale",
    technologies: ["Java", "ECS", "Maven"],
    category: ["Destaques", "GUI/CLI"],
    repoLink: "https://github.com/renancmd/rechunk",
    liveLink: "https://www.curseforge.com/hytale/mods/rechunk",
  },
  {
    title: "IDS",
    image: "/images/projects/ids.png",
    description: "Sistema de Detecção de Intrusos que monitora o tráfego de rede em tempo real",
    technologies: ["Python"],
    category: ["Destaques", "GUI/CLI"],
    repoLink: "https://github.com/renancmd/ids",
    liveLink: "https://github.com/renancmd/ids",
  },
  {
    title: "Port Scanner",
    image: "/images/projects/port-scanner.png",
    description:
      "Um Port Scanner eficiente projetado para analisar redes, identificar portas abertas e descobrir serviços em execução",
    technologies: ["Python"],
    category: ["Destaques", "GUI/CLI"],
    repoLink: "https://github.com/renancmd/port-scanner",
    liveLink: "https://github.com/renancmd/port-scanner",
  },
  {
    title: "Web Scraper",
    image: "/images/projects/web-scraper.png",
    description:
      "Uma ferramenta ágil desenvolvida para automatizar a extração de dados em sites",
    technologies: ["Python"],
    category: ["Destaques", "GUI/CLI"],
    repoLink: "https://github.com/renancmd/web-scraper",
    liveLink: "https://github.com/renancmd/web-scraper",
  },
  {
    title: "Arch Linux (Hyperland) - Setup",
    image: "/images/projects/arch-linux.jpg",
    description: "Meu set de configurações para Arch Linux com Hyprland",
    technologies: ["Linux", "DE", "WM", "Quickshell"],
    category: ["Destaques", "GUI/CLI"],
    repoLink: "https://github.com/renancmd/dotfiles",
    liveLink: "https://github.com/renancmd/dotfiles"
  },
  {
  ...
  {
    title: "Organon Security",
    image: "/images/projects/organon-security.png",
    description:
      "(Em progresso...) - Password manager Open-Source de uso local, garantindo controle total",
    technologies: ["Python", "Hash", "Criptografia"],
    category: ["GUI/CLI"],
    repoLink: "https://github.com/renancmd/organon-security",
    liveLink: "https://github.com/renancmd/organon-security",
  },
  {
    title: "Dashboard de Vendas",
    image: "/images/projects/dashboard-de-vendas.png",
    description:
      "Dashboard interativo para analisar dados de vendas de uma rede de varejo global.",
    technologies: ["Python", "Docker", "PostgreSQL"],
    category: ["Web"],
    repoLink: "https://github.com/renancmd/dashboard-de-vendas",
    liveLink:
      "https://dashboard-de-vendas-flvoapptduaaefh3mvadgsa.streamlit.app/",
  },
  {
        ...
        >
          <div className="container mx-auto px-6 text-center">
            <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-4">
              Renan <span className="text-cyan-400">Vieira</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              ...
              <a
                href="/pdf/Renan (Currículo) - Virtual.pdf"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <div className="bg-gray-900 p-8 rounded-lg shadow-lg">
                ...
                <ul className="list-disc list-inside text-gray-300 space-y-2">
                  <li>Security Tools & OWASP Top 10</li>
                  <li>Redes & Protocolos</li>
                  <li>Linux Avançado & VMs</li>
                  <li>Python & Bash</li>
                  <li>Java & C/C++/C#</li>
